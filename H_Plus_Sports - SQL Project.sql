-- =========================================================
-- H+ Plus Sports: Customer and Sales Aanalysis
-- Obejective: Upkeep customer and sales data and improve sales for the mineral water department
-- =========================================================

-- About the company
-- H+ Sport is a fictitious company that sells nutritional products and active lifestyle clothing. H+ Sport is dedicated to creating eco-friendly, high quality, nutrient-rich nutritional products that enhance active lifestyles, along with clothing that is made to be functional, stylish, comfortable, and durable.
